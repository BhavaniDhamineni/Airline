...
public class UserDto {
	...
	private String searchByFlightId;
	...
	public UserDto(int userId, String userName, String firstName, String lastName, String email, long mobileNo,
			...
			String searchFlightsByDateUrl,String searchFlightsByLocationsAndFareUrl,String searchByFlightId) {
		super();
		this.userId = userId;
		...
		this.searchByFlightId=searchByFlightId;
	}
	...
	public void setUserId(int userId) {
		...
		this.searchByFlightId="http://localhost:9099/api/v1/getFlightByFlightId/{flightId}";
	}
	...
	public String getSearchByFlightId() {
		return searchByFlightId;
	}



	public void setSearchByFlightId(String searchByFlightId) {
		this.searchByFlightId = searchByFlightId;
	}
	...
	public String toString() {
		return "UserDto [userId=" + userId + ", userName=" + userName + ", firstName=" + firstName + ", lastName="
				...
				+ searchFlightsByLocationsAndFareUrl + ", searchByFlightId=" + searchByFlightId + "]";
	}
